    ...
    module Core
      ...
      module BookLinkUtils
        ...
        def self.render_book_link_from_data(title, url, context)
          ...
          Jekyll::Infrastructure::Links::LinkHelperUtils._generate_link_html(context, url, cite_element)
        end
        ...
        def self._build_book_cite_element(display_text)
          # Use _prepare_display_title from Jekyll::Infrastructure::TypographyUtils

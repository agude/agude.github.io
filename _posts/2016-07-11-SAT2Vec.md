...
{% capture file_dir %}{{ site.url }}/files/sat2vec{% endcapture %}

![Leonid Pasternak's painting The Night Before the Exam]({{ file_dir
}}/Pasternak_The_Night_Before_the_Exam.jpg)
...
[notebook]: {{ file_dir }}/Word2Vec SAT.ipynb
...
[results]: {{ site.url }}/blog/sat2vec/results/

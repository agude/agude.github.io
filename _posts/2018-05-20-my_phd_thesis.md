...
image_alt: >
  A color photo of Building 40 at CERN at sunset.
use_latex: True
---
...
characteristic, for example containing two high energy electrons, we would see
based on our understanding of the Standard Model. Then we count the number of
events that CMS recorded with those characteristics.

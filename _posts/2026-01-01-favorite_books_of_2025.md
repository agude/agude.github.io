...
description: >
    In 2025, I read xxx books. From sequels to classics, here are my favorite
    reads of the year.
...
{% capture qntm %}{% author_link "qntm" link_text="qntm" %}{% endcapture %}
...
{% capture evans %}{% author_link "Linda Evans" link_text="Evans" %}{% endcapture %}
{% capture hollingsworth %}{% author_link "Robert R. Hollingsworth" link_text="Hollingsworth" %}{% endcapture %}
{% capture weber %}{% author_link "David Weber" link_text="Weber" %}{% endcapture %}

...
{% capture winterss_lastname %}{% author_link "Ben H. Winters" link_text="Winters" possessive %}{% endcapture %}
{% capture the_last_policeman %}{% series_link "The Last Policeman" %}{% endcapture %}
{% capture countdown_city %}{% book_link "Countdown City" %}{% endcapture %}

{% capture severance %}{% tv_show_title "Severance" %}{% endcapture %}
...
{% capture tron %}{% movie_title "Tron" %}{% endcapture %}
...
{% capture breaking_bad %}{% tv_show_title "Breaking Bad" %}{% endcapture %}
...
{% capture melvilles %}{% author_link "Herman Melville" possessive %}{% endcapture %}

...
}}</span>, is the first book in the long-running <span class="book-series">{{
page.series }}</span> series of military science fiction. It introduces
Commander Honor Harrington, a brilliant naval officer exiled to a remote star
system with an aging ship and a demoralized crew. There, she must enforce the
law and uncover a smuggling plot that proves to be the opening move in an
interstellar war.

...
{% capture this_book %}<cite class="book-title">There Is No Antimemetics Division</cite>{% endcapture %}
...
The short-story origins of the book mean there are no wasted words and the
...
just keeps ramping up. Likewise, the world is like a stage: just wide enough
to contain the action.

The sparsity and jumps backwards and forwards through time sort of work with
...
Overall, it offers fun ideas with a weak execution. I wish it had lived up to
its excellent concept.

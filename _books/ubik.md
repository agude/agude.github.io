...
{% capture butler %}{% author_link "Octavia E. Butler" %}{% endcapture %}
{% capture butlers %}{% author_link "Octavia E. Butler" possessive %}{% endcapture %}
{% capture butler_lastname %}{% author_link "Octavia E. Butler" link_text="Butler" %}{% endcapture %}
{% capture butlers_lastname %}{% author_link "Octavia E. Butler" link_text="Butler" possessive %}{% endcapture %}
{% capture patternist %}{% series_link "Patternist" %}{% endcapture %}
{% capture wild_seed %}{% book_link "Wild Seed" %}{% endcapture %}

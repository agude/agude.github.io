...
class="book-series">{{ page.series }}</span> series, keeping <span
class="nowrap">{% book_link "Chevalier" %}'s</span> action and quick pacing
while adding more backstory, character development, and a more complex plot.

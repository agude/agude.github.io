...
awards:
  - locus
canonical_url: /books/the_fall_of_hyperion/
...
{% book_link page.title %} is a sequel that outshines its predecessor. It is
everything I was expecting from {% book_link "Hyperion" %} and more! A true
masterpiece.

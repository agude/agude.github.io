...
require_relative '../../../../_plugins/src/infrastructure/links/markdown_link_formatter'

# Tests for Jekyll::Infrastructure::Links::MarkdownLinkFormatter.
#
...
class TestMarkdownLinkFormatter < Minitest::Test
  def test_format_link_found
    ...
    assert_equal '[Dune](/books/dune/)', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data)
  end

  def test_format_link_not_found
    data = { status: :not_found, url: nil, display_text: 'Unknown Book' }
    assert_equal 'Unknown Book', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data)
  end

  def test_format_link_found_but_nil_url
    data = { status: :found, url: nil, display_text: 'No URL' }
    assert_equal 'No URL', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data)
  end

  def test_format_link_empty_display_text
    data = { status: :found, url: '/books/test/', display_text: '' }
    assert_equal '[](/books/test/)', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data)
  end

  def test_format_link_nil_display_text
    data = { status: :not_found, url: nil, display_text: nil }
    assert_equal '', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data)
  end

  def test_format_link_ambiguous_status
    data = { status: :ambiguous, url: nil, display_text: 'Ambiguous Title' }
    assert_equal 'Ambiguous Title', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data)
  end
  ...
  def test_format_link_italic_found
    data = { status: :found, url: '/books/dune/', display_text: 'Dune' }
    assert_equal '[_Dune_](/books/dune/)', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data, italic: true)
  end

  def test_format_link_italic_not_found
    data = { status: :not_found, url: nil, display_text: 'Unknown Book' }
    assert_equal '_Unknown Book_', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data, italic: true)
  end

  def test_format_link_italic_found_but_nil_url
    data = { status: :found, url: nil, display_text: 'No URL' }
    assert_equal '_No URL_', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data, italic: true)
  end

  def test_format_link_italic_nil_display_text
    data = { status: :not_found, url: nil, display_text: nil }
    assert_equal '', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data, italic: true)
  end
  ...
  def test_format_link_escapes_brackets_in_text
    ...
    result = Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data)
  ...
  def test_format_link_italic_with_brackets
    ...
    result = Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data, italic: true)
  ...
  def test_format_link_self_link_returns_plain_text
    data = { status: :found, url: '/books/dune/', display_text: 'Dune' }
    assert_equal 'Dune', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data, self_link: true)
  end

  def test_format_link_self_link_with_italic
    data = { status: :found, url: '/books/dune/', display_text: 'Dune' }
    assert_equal '_Dune_', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data, italic: true, self_link: true)
  end

  def test_format_link_self_link_not_found_returns_plain_text
    data = { status: :not_found, url: nil, display_text: 'Unknown' }
    assert_equal 'Unknown', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data, self_link: true)
  end

  def test_format_link_self_link_false_still_links
    data = { status: :found, url: '/books/dune/', display_text: 'Dune' }
    assert_equal '[Dune](/books/dune/)', Jekyll::Infrastructure::Links::MarkdownLinkFormatter.format_link(data, self_link: false)
  end
end

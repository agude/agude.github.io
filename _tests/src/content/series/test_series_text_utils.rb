...
# Tests for Jekyll::Series::SeriesTextUtils module.
#
...
class TestSeriesTextUtils < Minitest::Test
  def test_analyze_series_name_basic
    result = Jekyll::Series::SeriesTextUtils.analyze_series_name('Foundation')
    expected = { prefix: 'the ', name: 'Foundation', suffix: ' series' }
    assert_equal expected, result
  end

  def test_analyze_series_name_starts_with_the
    result = Jekyll::Series::SeriesTextUtils.analyze_series_name('The Expanse')
    expected = { prefix: '', name: 'The Expanse', suffix: ' series' }
    assert_equal expected, result
  end

  def test_analyze_series_name_starts_with_a
    result = Jekyll::Series::SeriesTextUtils.analyze_series_name('A Canticle for Leibowitz')
  ...
  def test_analyze_series_name_starts_with_an
    result = Jekyll::Series::SeriesTextUtils.analyze_series_name('Ancillary Justice')
  ...
  def test_analyze_series_name_keyword_with_trailing_punctuation
    ...
    result = Jekyll::Series::SeriesTextUtils.analyze_series_name('The Culture series.')
  ...
  def test_analyze_series_name_no_keywords_complex_name
    result = Jekyll::Series::SeriesTextUtils.analyze_series_name('His Dark Materials')
  ...
  def test_analyze_series_name_input_with_extra_whitespace
    ...
    result_the = Jekyll::Series::SeriesTextUtils.analyze_series_name('   The Expanse   ')
  ...
  def test_analyze_series_name_nil_input
    assert_nil Jekyll::Series::SeriesTextUtils.analyze_series_name(nil)
  end

  def test_analyze_series_name_empty_string_input
    assert_nil Jekyll::Series::SeriesTextUtils.analyze_series_name('')
  end
  ...
  def test_analyze_series_name_keyword_as_substring_does_not_match
    ...
    result = Jekyll::Series::SeriesTextUtils.analyze_series_name('Arcane')
    expected = { prefix: 'the ', name: 'Arcane', suffix: ' series' }
    assert_equal expected, result
  end

  def test_analyze_series_name_multiple_keywords
    result = Jekyll::Series::SeriesTextUtils.analyze_series_name('The Great Book Saga Collection')

...
# Test class for Jekyll::Books::Lists::SeriesFinder
class TestBookListSeriesFinder < Minitest::Test
  ...
  def test_find_with_nil_filter_logs_warn
    ...
    assert_empty data[:books]
    assert_match %r{<!-- \[WARN\] BOOK_LIST_SERIES_DISPLAY_FAILURE: Reason='Series name filter was empty or nil\.'\s*SeriesFilterInput='N/A'\s*SourcePage='current_page\.html' -->},
                 data[:log_messages]
  end

...
# Tests for Jekyll::SEO::Generators::BookReviewGenerator class.
#
# Verifies that the generator correctly creates JSON-LD structured data for book reviews.
class TestBookReviewGenerator < Minitest::Test
  def setup
    @site_config = {
  ...
  def test_generate_hash_book_review_multiple_authors
    ...
    actual = Jekyll::SEO::Generators::BookReviewGenerator.new(doc, @site).generate

...
class TestCardRendererUtils < Minitest::Test
  ...
  def test_render_minimal_card_data
    ...
    assert_match %r{<div class="minimal-card">}, output
    assert_match %r{<div class="card-element card-text">}, output
    assert_match %r{<a href="/item/1">\s*<strong>Minimal Title</strong>\s*</a>}, output
    refute_match %r{<img src=}, output, "Image should not be present for minimal card"
    refute_match %r{<br>}, output, "Description break should not be present" # Assuming default wrappers are empty
  ...
  def test_render_card_with_image
    ...
    assert_match %r{<div class="image-card">}, output
    assert_match %r{<div class="card-element custom-image-class">}, output
  ...
  def test_render_card_all_elements_present
    ...
    assert_match %r{<div class="full-card">}, output

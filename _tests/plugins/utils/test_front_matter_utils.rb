...
class TestFrontMatterUtils < Minitest::Test
  ...
  def test_string_input_single_value
    ...
    assert_equal expected, FrontMatterUtils.get_list_from_string_or_array(input)
  end
  ...
  def test_array_input_with_non_string_elements_that_become_empty
    ...
    assert_equal expected_predictable, FrontMatterUtils.get_list_from_string_or_array(input)
  end
  ...
  def test_unsupported_type_input_integer
    input = 12345 # Not a string or array
    expected = []
    assert_equal expected, FrontMatterUtils.get_list_from_string_or_array(input)
  end

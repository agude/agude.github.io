...
class TestTypographyUtils < Minitest::Test # Renamed class
  ...
  def test_prepare_display_title_mixed_quotes
    assert_equal "“Don’t say ‘hello’ like that,” she said.", TypographyUtils.prepare_display_title("\"Don't say 'hello' like that,\" she said.")
    assert_equal "He replied, ‘I heard him say “Stop!” just now.’", TypographyUtils.prepare_display_title("He replied, 'I heard him say \"Stop!\" just now.'")
  end
  ...
  def test_prepare_display_title_combinations_with_escaping
    ...
    assert_equal "Safe &amp; &lt;Tags&gt; – Not ‘Bad’", TypographyUtils.prepare_display_title("Safe & <Tags> -- Not 'Bad'")
  end
  ...
  def test_prepare_display_title_combinations_with_br
    ...
    assert_equal "Line 1<br>It’s – “Okay”", TypographyUtils.prepare_display_title("Line 1<br />It's -- \"Okay\"")
    assert_equal "&lt;Start&gt; First – then<br>Second", TypographyUtils.prepare_display_title("<Start> First -- then<br>Second")
  end
end

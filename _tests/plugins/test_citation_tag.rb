...
class TestCitationTag < Minitest::Test
  ...
  def test_initialize_syntax_error_for_equals_without_value
    ...
    assert_match %r{Syntax Error in 'citation' tag: Invalid arguments near 'author_last=' in 'author_last='}, err.message
  end
  ...
  def test_render_parses_and_resolves_quoted_string_arguments
    ...
    captured_args = nil
    CitationUtils.stub :format_citation_html, ->(params, site) { captured_args = { params: params, site: site }; mock_output_html } do

...
# Tests for DisplayUnreviewedMentions::Finder class.
#
...
# Tests for DisplayUnreviewedMentions::Renderer class.
#
...
class TestDisplayUnreviewedMentionsRenderer < Minitest::Test
  def test_render_generates_ordered_list_for_populated_array
    ...
    renderer = Jekyll::DisplayUnreviewedMentions::Renderer.new(mentions)
  ...
  def test_render_returns_no_mentions_message_for_empty_array
    renderer = Jekyll::DisplayUnreviewedMentions::Renderer.new([])
    output = renderer.render
...
# Integration test for DisplayUnreviewedMentionsTag Liquid tag.
#

...
class TestLiquidUtilsRenderRatingStars < Minitest::Test
  ...
  def assert_stars(html, full_count, empty_count)
    ...
    extracted_chars = html.scan(/<span class="book_star (?:full_star|empty_star)"[^>]*>([★☆])<\/span>/).flatten
  ...
  def test_render_rating_stars_valid_integers
    output5 = LiquidUtils.render_rating_stars(5)
    ...
    output3 = LiquidUtils.render_rating_stars(3)
    ...
    output1 = LiquidUtils.render_rating_stars(1)
  ...
  def test_render_rating_stars_valid_strings
    output4_str = LiquidUtils.render_rating_stars("4")
    ...
    output2_str = LiquidUtils.render_rating_stars("2")

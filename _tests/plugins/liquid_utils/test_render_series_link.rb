...
class TestLiquidUtilsRenderSeriesLink < Minitest::Test
  ...
  def test_render_series_link_found_and_linked
    ...
    actual_html = LiquidUtils.render_series_link("My Awesome Series", ctx)
  ...
  def test_render_series_link_not_found
    ...
    actual_html = LiquidUtils.render_series_link("NonExistent Series", ctx)
  ...
  def test_render_series_link_with_link_text_override_found
    ...
    actual_html = LiquidUtils.render_series_link("My Awesome Series", ctx, "Display This Instead")
  ...
  def test_render_series_link_with_link_text_override_not_found
    ...
    actual_html = LiquidUtils.render_series_link("NonExistent Series", ctx, "Display This Instead")
  ...
  def test_render_series_link_empty_input_title
    ...
    assert_equal "", LiquidUtils.render_series_link("", ctx)
    assert_equal "", LiquidUtils.render_series_link("   ", ctx) # Whitespace only
    assert_equal "", LiquidUtils.render_series_link(nil, ctx)
  end
  ...
  def test_render_series_link_escaping
    ...
    actual_html = LiquidUtils.render_series_link("Series <Title> & Stuff", ctx)
  ...
  def test_render_series_link_uses_canonical_title_from_page
    ...
    series_page = create_doc({ 'title' => '  My canonical   SERIES title ', 'layout' => 'series_page' }, '/series/canonical.html')
    site = create_site({}, {}, [series_page])
    current_page = create_doc({}, '/current-page.html')
    ctx = create_context({}, { site: site, page: current_page })
    ...
    actual_html = LiquidUtils.render_series_link(input_title, ctx)

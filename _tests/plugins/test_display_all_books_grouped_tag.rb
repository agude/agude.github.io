...
class TestDisplayAllBooksGroupedTag < Minitest::Test
  ...
  def test_renders_nav_and_all_books_correctly_grouped_and_sorted
    ...
    assert_match %r{<h2 class="series-title" id="series-alpha">.*<span class="book-series">Series Alpha</span>.*</h2>}, output
    ...
    assert_match %r{<h2 class="series-title" id="series-beta">.*<span class="book-series">Series Beta</span>.*</h2>}, output

...
class TestDisplayPreviousReviewsTag < Minitest::Test
  ...
  def test_logs_error_if_prerequisites_missing
    ...
    assert_match %r{<!-- \[ERROR\] PREVIOUS_REVIEWS_FAILURE: Reason='Prerequisites missing: site, page, or page\.url\.' .*? -->}, output
  end
end
